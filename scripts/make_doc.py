...
text = """# FINAL RAZORPAY BUILDATHON VALIDATION & INTEGRATION REPORT
...
with open('docs/FINAL_RAZORPAY_BUILDATHON_VALIDATION.md', 'w') as f:
    f.write(text)

print("Created docs/FINAL_RAZORPAY_BUILDATHON_VALIDATION.md successfully")
